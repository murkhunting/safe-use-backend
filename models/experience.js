...
const experienceSchema = new Schema({
  ...
  intention: {type: String, enum: ["Discover", "Grow", "Fun", "Transform", "Heal", "Concentration", "Relax"], required: true},
  userexperience: {type: String, enum: ["First Time", "Occasionally", "Often", "Habitually"], required: true},
  notes: [{type: String}],
  voiceNotes: []
}, {
  timestamps: {
